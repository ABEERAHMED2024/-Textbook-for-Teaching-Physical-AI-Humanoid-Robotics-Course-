...
3. **Start Module 1**: [ROS 2 Architecture](./module-1-ros2/index)
...
<div style={{marginTop: '2rem'}}>
  <a href="@site/docs/setup/workstation.md" className="button button--primary button--lg" style={{marginRight: '1rem'}}>
    Workstation Setup →
  </a>
  <a href="@site/docs/module-1-ros2/index.md" className="button button--secondary button--lg">
    Jump to Module 1 →
  </a>
</div>
