...
def fix_metadata():
    files = {
        ...
        'docs/module-2-digital-twin/week-6-gazebo.mdx': {
            ...
            'learning_objectives': [
                "Implement Gazebo setup with ROS 2 integration for simulation",
                "Build physics-accurate worlds using SDF (Simulation Description Format)",
        ...
        'docs/module-2-digital-twin/week-7-unity-sensors.mdx': {
            ...
            'learning_objectives': [
                ...
                "Simulate photorealistic camera data with realistic environmental noise",
        ...
        'docs/module-3-isaac/week-10-nav2-rl.mdx': {
            ...
            'difficulty': "advanced",
            'learning_objectives': [
                "Configure the ROS 2 Navigation Stack (Nav2) for humanoid platforms",
                "Understand costmaps, planners, and behavior tree controllers",
                "Build a simple locomotion policy using Reinforcement Learning in Isaac",
                "Evaluate the tradeoffs between classical navigation and RL-based control"
            ]
        },
